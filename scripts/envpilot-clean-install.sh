...
RELEASE_VERSION="${ENVPILOT_RELEASE_VERSION:-0.1.2}"
IMAGE_TAG="${ENVPILOT_IMAGE_TAG:-${RELEASE_VERSION}}"
AGENT_IMAGE_TAG="${ENVPILOT_AGENT_IMAGE_TAG:-0.1.1}"
RUNNER_IMAGE_TAG="${ENVPILOT_RUNNER_IMAGE_TAG:-${RELEASE_VERSION}}"
...
install_control_plane() {
  ...
  add_set "frontend.image.tag" "${IMAGE_TAG}"
