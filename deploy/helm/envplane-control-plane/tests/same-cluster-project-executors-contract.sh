...
rg -Fq 'kind: ClusterPolicy' "$rendered"
rg -Fq 'name: envplane-control-plane-same-cluster-rbac-guard' "$rendered"
rg -Fq 'validationFailureAction: Enforce' "$rendered"
rg -Fq 'deny-cluster-admin-bindings' "$rendered"
rg -Fq 'Bindings to cluster-admin are not permitted.' "$rendered"
rg -Fq 'restrict-control-plane-cluster-role-bindings' "$rendered"
rg -Fq 'restrict-control-plane-cluster-roles' "$rendered"
rg -Fq 'operator: NotIn' "$rendered"
rg -Fq -- '- envplane-control-plane-same-cluster-project-executor-release-manager' "$rendered"
...
rg -Fq 'value: ClusterRole' "$rendered"
